...
bkcore.hexgl.tracks.Cityscape = {
	...
	load: function (game, user, opts, quality) {
		...
		let booster = "feisar";
		let track = "cityscape";
		let skybox = "dawnclouds";

		// let user = JSON.parse(user); // Parse user string into object
		// let game = JSON.parse(game); // Parse game string into object

		console.log("launching track with user : ", user);
		console.log("launching track with game : ", game);

		if (user.username) {
			console.log("detect new ship");
			ship = "terminator";
		}

		if (user.coins > 0) {
			console.log("detect new booster");
			booster = "terminator";
		}

		if (user.level) {
			console.log("detect new track");
			track = "spacescape";
		}

		if (user.level) {
			console.log("detect new sky");
			skybox = "spaceclouds";
		}

		console.log(`ship : ${ship},booster:${booster} ,track:${track}, skybox:${skybox} `);
		// desktop + quality low
		// OR
		...
		else // HIGH
		{
			...
			this.lib.load({
				textures: {
					...
					'ship.feisar.diffuse': `textures.full/ships/${ship}/diffuse.jpg`,
					'ship.feisar.specular': `textures.full/ships/${ship}/specular.jpg`,
					'ship.feisar.normal': `textures.full/ships/${ship}/normal.jpg`,
					'booster.diffuse': `textures.full/ships/${booster}/booster/booster.png`,
					'booster.sprite': `textures.full/ships/${booster}/booster/boostersprite.jpg`,
					'track.cityscape.diffuse': `textures.full/tracks/${track}/diffuse.jpg`,
					'track.cityscape.specular': `textures.full/tracks/${track}/specular.jpg`,
					'track.cityscape.normal': `textures.full/tracks/${track}/normal.jpg`,
					'track.cityscape.scrapers1.diffuse': `textures.full/tracks/${track}/scrapers1/diffuse.jpg`,
					'track.cityscape.scrapers1.specular': `textures.full/tracks/${track}/scrapers1/specular.jpg`,
					'track.cityscape.scrapers1.normal': `textures.full/tracks/${track}/scrapers1/normal.jpg`,
					'track.cityscape.scrapers2.diffuse': `textures.full/tracks/${track}/scrapers2/diffuse.jpg`,
					'track.cityscape.scrapers2.specular': `textures.full/tracks/${track}/scrapers2/specular.jpg`,
					'track.cityscape.scrapers2.normal': `textures.full/tracks/${track}/scrapers2/normal.jpg`,
					'track.cityscape.start.diffuse': `textures.full/tracks/${track}/start/diffuse.jpg`,
					'track.cityscape.start.specular': `textures.full/tracks/${track}/start/specular.jpg`,
					'track.cityscape.start.normal': `textures.full/tracks/${track}/start/normal.jpg`,
					'track.cityscape.start.banner': `textures.full/tracks/${track}/start/start.jpg`,
				...
				texturesCube: {
					'skybox.dawnclouds': `textures.full/skybox/${skybox}/%1.jpg`
				},
				geometries: {
					'bonus.base': "geometries/bonus/base/base.js",
					'booster': "geometries/booster/booster.js",
				...
				analysers: {
					'track.cityscape.collision': `textures.full/tracks/${track}/collision.png`,
					'track.cityscape.height': `textures.full/tracks/${track}/height.png`
				},
				images: {
